...
return [
    ...
    //seo
    ['name' => 'seo.homepage_title', 'value' => 'BeDrive - Cloud Storage'],
    ['name' => 'seo.homepage_description', 'value' => 'BeDrive provides secure cloud storage for your photos, videos, music and other files.'],
    ['name' => 'seo.homepage_tags', 'value' => "files, secure, cloud, storage"],
